    ...
    <>
      <form className='border rounded bg-light p-4'>
        <div className="mb-3">
          ...
          <input type="text" name="name" className="form-control" id="exsampleAuthor" placeholder="inserisci l'autore" />
        </div>
        <div className="mb-3">
          <label for="exsampleTitle" className="form-label">Titolo del post</label>
          <input type="text" name="title" className="form-control" id="exsampleTitle" placeholder="inserisci il titolo del post" />
        </div>
        <div className="mb-3">
          <label for="exampleFormControlTextarea1" className="form-label">Testo del post</label>
          <textarea className="form-control" name="text" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        <div className="form-check">
          <input className="form-check-input" name="updates" type="checkbox" value="" id="checkIndeterminate" />
